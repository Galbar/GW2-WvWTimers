...
var objectives = new Array();
			objectives[ 1 ] = ["Aussichtspunkt",25, 0, 130, 270];
			objectives[ 2 ] = ["Tal",25, 0, 366, 392];
			objectives[ 3 ] = ["Tiefland",25, 0, 360, 90];
			objectives[ 4 ] = ["Golanta-Lichtung",5, 0, 420, 180];
			objectives[ 5 ] = ["Pangloss-Anhöhe",5, 0, 140, 355];
			objectives[ 6 ] = ["Speldan Kahlschlag",5, 0, 115, 118];
			objectives[ 7 ] = ["Danelon-Passage",5, 0, 436, 308];
			objectives[ 8 ] = ["Umberlichtung-Forst",5, 0, 250, 408];
			objectives[ 9 ] = ["Schloss Steinnebel",35, 0, 276, 247];
			objectives[ 10 ] = ["Schurkenbruch",5, 0, 250, 80];
			objectives[ 11 ] = ["Aldons Vorsprung",10, 0, 314, 54];
			objectives[ 12 ] = ["Wildbachstrecke",10, 0, 280, 134];
			objectives[ 13 ] = ["Jerrifers Sumpfloch",10, 0, 408, 122];
			objectives[ 14 ] = ["Klovan-Senke",10, 0, 357, 173];
			objectives[ 15 ] = ["Langor - Schlucht",10, 0, 425, 380];
			objectives[ 16 ] = ["Quentinsee",10, 0, 380, 288];
			objectives[ 17 ] = ["Mendons Spalt",10, 0, 100, 190];
			objectives[ 18 ] = ["Anzalias-Pass",10, 0, 188, 183];
			objectives[ 19 ] = ["Ogerwacht-Kanal",10, 0, 165, 315];
			objectives[ 20 ] = ["Veloka-Hang",10, 0, 100, 315];
			objectives[ 21 ] = ["Durios-Schlucht",10, 0, 265, 340];
			objectives[ 22 ] = ["Bravost-Abhang",10, 0, 312, 426];
			objectives[ 23 ] = ["Festung",25, 0, 280, 230];
			objectives[ 24 ] = ["Landgut des Champions",5, 0, 586, 233];
			objectives[ 25 ] = ["Rotdornstrauch",10, 0, 458, 156];
			objectives[ 26 ] = ["Grünsee",10, 0, 468, 332];
			objectives[ 27 ] = ["Bucht des Aufstiegs",25, 0, 383, 31];
			objectives[ 28 ] = ["Horst der Morgendammerung",10, 0, 209, 351];
			objectives[ 29 ] = ["Der Geisterholm",5, 0, 46, 235];
			objectives[ 30 ] = ["Wald - Freistatt",10, 0, 208, 109];
			objectives[ 31 ] = ["Askalion - Hügel",25, 0, 368, 462];
			objectives[ 32 ] = ["Etheron - Hügel",25, 0, 368, 462];
			objectives[ 33 ] = ["Traumbucht",25, 0, 383, 31];
			objectives[ 34 ] = ["Sieger - Hütte",5, 0, 586, 233];
			objectives[ 35 ] = ["Grünstrauch",10, 0, 458, 156];
			objectives[ 36 ] = ["Blausee",10, 0, 468, 332];
			objectives[ 37 ] = ["Festung",25, 0, 280, 230];
			objectives[ 38 ] = ["Weitsicht",10, 0, 208, 109];
			objectives[ 39 ] = ["Das Gottschwert",5, 0, 46, 235];
			objectives[ 40 ] = ["Felswand",10, 0, 209, 351];
			objectives[ 41 ] = ["Shadaran Hügel",25, 0, 368, 462];
			objectives[ 42 ] = ["Rotsee",10, 0, 468, 332];
			objectives[ 43 ] = ["Hütte des Helden",5, 0, 586, 233];
			objectives[ 44 ] = ["Schreckensfall - Bucht",25, 0, 383, 31];
			objectives[ 45 ] = ["Blaudornstrauch",10, 0, 458, 156];
			objectives[ 46 ] = ["Festung",25, 0, 280, 230];
			objectives[ 47 ] = ["Sonnenlichthügel",10, 0, 208, 109];
			objectives[ 48 ] = ["Glaubenssprung",5, 0, 236, 64];
			objectives[ 49 ] = ["Blautal - Zuflucht",5, 0, 480, 70];
			objectives[ 50 ] = ["Blauwasser - Tiefland",5, 0, 490, 420];
			objectives[ 51 ] = ["Astralholm",5, 0, 228, 422];
			objectives[ 52 ] = ["Arahs Hoffnung",5, 0, 236, 64];
			objectives[ 53 ] = ["Grüntal - Zuflucht",5, 0, 480, 70];
			objectives[ 54 ] = ["Nebel - Freistatt",5, 0, 228, 422];
			objectives[ 55 ] = ["Rotwasser - Tiefland",5, 0, 490, 420];
			objectives[ 56 ] = ["Die Titanenpranke",5, 0, 46, 235];
			objectives[ 57 ] = ["Felsenspitze",10, 0, 209, 351];
			objectives[ 58 ] = ["Götterkunde",5, 0, 236, 64];
			objectives[ 59 ] = ["Rottal - Zuflucht",5, 0, 480, 70];
			objectives[ 60 ] = ["Sternenhain",5, 0, 228, 422];
			objectives[ 61 ] = ["Grünwasser - Tiefland",5, 0, 490, 420];
