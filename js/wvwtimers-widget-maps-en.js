...
var objectives = new Array();
			objectives[ 1 ] = ["Overlook",25, 0, 130, 270];
			objectives[ 2 ] = ["Valley",25, 0, 366, 392];
			objectives[ 3 ] = ["Lowlands",25, 0, 360, 90];
			objectives[ 4 ] = ["Golanta Clearing",5, 0, 420, 180];
			objectives[ 5 ] = ["Pangloss Rise",5, 0, 140, 355];
			objectives[ 6 ] = ["Speldan Clearcut",5, 0, 115, 118];
			objectives[ 7 ] = ["Danelon Passage",5, 0, 436, 308];
			objectives[ 8 ] = ["Umberglade Woods",5, 0, 250, 408];
			objectives[ 9 ] = ["Stonemist Castle",35, 0, 276, 247];
			objectives[ 10 ] = ["Rogue's Quarry",5, 0, 250, 80];
			objectives[ 11 ] = ["Aldon's Ledge",10, 0, 314, 54];
			objectives[ 12 ] = ["Wildcreek Run",10, 0, 280, 134];
			objectives[ 13 ] = ["Jerrifer's Slough",10, 0, 408, 122];
			objectives[ 14 ] = ["Klovan Gully",10, 0, 357, 173];
			objectives[ 15 ] = ["Langor Gulch",10, 0, 425, 380];
			objectives[ 16 ] = ["Quentin Lake",10, 0, 380, 288];
			objectives[ 17 ] = ["Mendon's Gap",10, 0, 100, 190];
			objectives[ 18 ] = ["Anzalias Pass",10, 0, 188, 183];
			objectives[ 19 ] = ["Ogrewatch Cut",10, 0, 165, 315];
			objectives[ 20 ] = ["Veloka Slope",10, 0, 100, 315];
			objectives[ 21 ] = ["Durios Gulch",10, 0, 265, 340];
			objectives[ 22 ] = ["Bravost Escarpment",10, 0, 312, 426];
			objectives[ 23 ] = ["Garrison",25, 0, 280, 230];
			objectives[ 24 ] = ["Champion's demense",5, 0, 586, 233];
			objectives[ 25 ] = ["Redbriar",10, 0, 458, 156];
			objectives[ 26 ] = ["Greenlake",10, 0, 468, 332];
			objectives[ 27 ] = ["Ascension Bay",25, 0, 383, 31];
			objectives[ 28 ] = ["Dawn's Eyrie",10, 0, 209, 351];
			objectives[ 29 ] = ["The Spiritholme",5, 0, 46, 235];
			objectives[ 30 ] = ["Woodhaven",10, 0, 208, 109];
			objectives[ 31 ] = ["Askalion Hills",25, 0, 368, 462];
			objectives[ 32 ] = ["Etheron Hills",25, 0, 368, 462];
			objectives[ 33 ] = ["Dreaming Bay",25, 0, 383, 31];
			objectives[ 34 ] = ["Victors's Lodge",5, 0, 586, 233];
			objectives[ 35 ] = ["Greenbriar",10, 0, 458, 156];
			objectives[ 36 ] = ["Bluelake",10, 0, 468, 332];
			objectives[ 37 ] = ["Garrison",25, 0, 280, 230];
			objectives[ 38 ] = ["Longview",10, 0, 208, 109];
			objectives[ 39 ] = ["The Godsword",5, 0, 46, 235];
			objectives[ 40 ] = ["Cliffside",10, 0, 209, 351];
			objectives[ 41 ] = ["Shadaran Hills",25, 0, 368, 462];
			objectives[ 42 ] = ["Redlake",10, 0, 468, 332];
			objectives[ 43 ] = ["Hero's Lodge",5, 0, 586, 233];
			objectives[ 44 ] = ["Dreadfall Bay",25, 0, 383, 31];
			objectives[ 45 ] = ["Bluebriar",10, 0, 458, 156];
			objectives[ 46 ] = ["Garrison",25, 0, 280, 230];
			objectives[ 47 ] = ["Sunnyhill",10, 0, 208, 109];
			objectives[ 48 ] = ["Faithleap",5, 0, 236, 64];
			objectives[ 49 ] = ["Bluevale Refuge",5, 0, 480, 70];
			objectives[ 50 ] = ["Bluewater Lowlands",5, 0, 490, 420];
			objectives[ 51 ] = ["Astralholme",5, 0, 228, 422];
			objectives[ 52 ] = ["Arah's Hope",5, 0, 236, 64];
			objectives[ 53 ] = ["Greenvale Refuge",5, 0, 480, 70];
			objectives[ 54 ] = ["Foghaven",5, 0, 228, 422];
			objectives[ 55 ] = ["Redwater Lowlands",5, 0, 490, 420];
			objectives[ 56 ] = ["The Titanpaw",5, 0, 46, 235];
			objectives[ 57 ] = ["Cragtop",10, 0, 209, 351];
			objectives[ 58 ] = ["Godslore",5, 0, 236, 64];
			objectives[ 59 ] = ["Redvale Refuge",5, 0, 480, 70];
			objectives[ 60 ] = ["Stargrove",5, 0, 228, 422];
			objectives[ 61 ] = ["Greenwater Lowlands",5, 0, 490, 420];
...
if ($(".WvWTimers-widget").attr("mode") > "0")
{
	...
	"	<a href='#' class='NoTeamColor'>Eternal</a>"+
	"</li>"+
	"<li class='map-view'  id='GreenHome'>"+
	"	<a href='#' class='GreenTeamColor'>Green</a>"+
	"</li>"+
	"<li class='map-view'  id='BlueHome'>"+
	"	<a href='#' class='BlueTeamColor'>Blue</a>"+
	"</li>"+
	"<li class='map-view'  id='RedHome'>"+
	"	<a href='#' class='RedTeamColor'>Red</a>"+
	"</li>"+
	"</ul>"+
